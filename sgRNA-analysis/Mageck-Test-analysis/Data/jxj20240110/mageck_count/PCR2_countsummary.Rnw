...
library(xtable)
filelist=c("/public3/home/scg8403/Data/sgRNA/Data/Library- plasmid-PCR2-product_L3.fq");
labellist=c("PCR2");
reads=c(3219416);
mappedreads=c(2827086);
totalsgrnas=c(7142);
zerocounts=c(0);
giniindex=c(0.051744027695380446);
...
genboxplot("PCR2.count_normalized.txt");
@
...
genhistplot("PCR2.count_normalized.txt");
@
